import pickle
import socket
from constants import REGISTER, GETVALUE, APPEND, HOST
...
class DataObject:
    def __init__(self, host, port, list_id=None):  # -
        ...
        self.list_id = list_id  # the  n° of list for which this stub is meant  #-

    # -
    def send_receive(self, message):
        # type: (list) -> str or int
        sock = socket.socket()  # create a socket
        sock.connect((HOST, self.port))  # connect to server
