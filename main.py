...
decision = input("1 - Run Server\n"
                     "2 - Run Peer\n"
                     "Please select whichever you want.\n")
if decision == "1":
    HOST = input("Please enter the IP of the server in this format XXX.XXX.XXX.XXX. Enter 0 to run as localhost\n")
    PORT = input("Please enter the port number of which the server is going to listen to.\n")
    ...
    valid_boolean, valid_host, valid_port = validate_ip_port(PORT, HOST)
    if valid_boolean:
        choice = input("1 - Search for a filename and download it.\n"
        ...
        print ("Invalid Choice of server")
else:
